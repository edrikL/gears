/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/tinderbox/XR-Trunk/Linux_2.6.18-8.el5_Depend/mozilla/security/manager/ssl/public/nsISSLErrorListener.idl
 */
...
class NS_NO_VTABLE nsISSLErrorListener : public nsISupports {
 public: 
  ...
  NS_IMETHOD NotifySSLError(nsIInterfaceRequestor *socketInfo, PRInt32 error, const nsACString & targetSite, PRBool *_retval) = 0;
...
#define NS_DECL_NSISSLERRORLISTENER \
  NS_IMETHOD NotifySSLError(nsIInterfaceRequestor *socketInfo, PRInt32 error, const nsACString & targetSite, PRBool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISSLERRORLISTENER(_to) \
  NS_IMETHOD NotifySSLError(nsIInterfaceRequestor *socketInfo, PRInt32 error, const nsACString & targetSite, PRBool *_retval) { return _to NotifySSLError(socketInfo, error, targetSite, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISSLERRORLISTENER(_to) \
  NS_IMETHOD NotifySSLError(nsIInterfaceRequestor *socketInfo, PRInt32 error, const nsACString & targetSite, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->NotifySSLError(socketInfo, error, targetSite, _retval); } 
