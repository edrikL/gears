/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/tinderbox/XR-Trunk/Darwin_8.8.4_Depend/mozilla/security/manager/ssl/public/nsIIdentityInfo.idl
 */
...
class NS_NO_VTABLE nsIIdentityInfo : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetIsExtendedValidation(PRBool *aIsExtendedValidation) = 0;
...
#define NS_DECL_NSIIDENTITYINFO \
  NS_IMETHOD GetIsExtendedValidation(PRBool *aIsExtendedValidation); \
  NS_IMETHOD GetValidEVPolicyOid(nsACString & _retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIIDENTITYINFO(_to) \
  NS_IMETHOD GetIsExtendedValidation(PRBool *aIsExtendedValidation) { return _to GetIsExtendedValidation(aIsExtendedValidation); } \
...
#define NS_FORWARD_SAFE_NSIIDENTITYINFO(_to) \
  NS_IMETHOD GetIsExtendedValidation(PRBool *aIsExtendedValidation) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsExtendedValidation(aIsExtendedValidation); } \
