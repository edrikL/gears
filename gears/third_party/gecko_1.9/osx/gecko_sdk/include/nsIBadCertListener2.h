/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/tinderbox/XR-Trunk/Darwin_8.8.4_Depend/mozilla/security/manager/ssl/public/nsIBadCertListener2.idl
 */
...
class NS_NO_VTABLE nsIBadCertListener2 : public nsISupports {
 public: 
  ...
  NS_IMETHOD NotifyCertProblem(nsIInterfaceRequestor *socketInfo, nsISSLStatus *status, const nsACString & targetSite, PRBool *_retval) = 0;
...
#define NS_FORWARD_NSIBADCERTLISTENER2(_to) \
  NS_IMETHOD NotifyCertProblem(nsIInterfaceRequestor *socketInfo, nsISSLStatus *status, const nsACString & targetSite, PRBool *_retval) { return _to NotifyCertProblem(socketInfo, status, targetSite, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIBADCERTLISTENER2(_to) \
  NS_IMETHOD NotifyCertProblem(nsIInterfaceRequestor *socketInfo, nsISSLStatus *status, const nsACString & targetSite, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->NotifyCertProblem(socketInfo, status, targetSite, _retval); } 
