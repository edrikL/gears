/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM c:/fox15/mozilla/js/src/xpconnect/idl/nsIScriptableInterfaces.idl
 */
...
class NS_NO_VTABLE nsIScriptableInterfaces : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISCRIPTABLEINTERFACES_IID)
...
class NS_NO_VTABLE nsIScriptableInterfacesByID : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISCRIPTABLEINTERFACESBYID_IID)
