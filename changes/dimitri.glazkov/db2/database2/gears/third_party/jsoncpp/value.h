...
//# endif
   ...
   private:
      // girts: we provide just a declaration here without any implementation
      // to catch errors when a pointer is provided instead of object
      // (reference).
      Value( Value* other );
...
# endif
   ...
   public:
      ...
      virtual char *duplicateStringValue( const char *value, 
          unsigned int length = static_cast<unsigned int>(unknown) ) = 0;
    ...
    * actually uses a memory pool for speed).
    * \code
