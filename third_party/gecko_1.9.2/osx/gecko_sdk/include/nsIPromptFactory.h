/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/mozilla-1.9.2-macosx-xulrunner/build/embedding/components/windowwatcher/public/nsIPromptFactory.idl
 */
