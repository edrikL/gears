/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/mozilla-1.9.2-macosx-xulrunner/build/modules/plugin/base/public/nsIPluginTagInfo2.idl
 */
...
class NS_NO_VTABLE nsIPluginTagInfo2 : public nsIPluginTagInfoOld {
 public: 
