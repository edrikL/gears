/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/mozilla-1.9.2-macosx-xulrunner/build/toolkit/components/passwordmgr/public/nsILoginManagerStorage.idl
 */
