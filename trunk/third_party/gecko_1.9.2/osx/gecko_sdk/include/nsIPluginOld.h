/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/mozilla-1.9.2-macosx-xulrunner/build/modules/plugin/base/public/nsIPluginOld.idl
 */

#ifndef __gen_nsIPluginOld_h__
#define __gen_nsIPluginOld_h__
...
/* starting interface:    nsIPluginOld */
#define NS_IPLUGINOLD_IID_STR "df773070-0199-11d2-815b-006008119d7a"

#define NS_IPLUGINOLD_IID \
 ...
 * by the Stop method. 
 */
class NS_NO_VTABLE nsIPluginOld : public nsIFactory {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IPLUGINOLD_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIPluginOld, NS_IPLUGINOLD_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIPLUGINOLD \
...
#define NS_FORWARD_NSIPLUGINOLD(_to) \
...
#define NS_FORWARD_SAFE_NSIPLUGINOLD(_to) \
...
/* Header file */
class nsPluginOld : public nsIPluginOld
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSIPLUGINOLD
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsPluginOld, nsIPluginOld)

nsPluginOld::nsPluginOld()
{
...
/* void createPluginInstance (in nsISupports aOuter, in nsIIDRef aIID, in string aPluginMIMEType, [iid_is (aIID), retval] out nsQIResult aResult); */
NS_IMETHODIMP nsPluginOld::CreatePluginInstance(nsISupports *aOuter, const nsIID & aIID, const char *aPluginMIMEType, void * *aResult NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void initialize (); */
NS_IMETHODIMP nsPluginOld::Initialize()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void shutdown (); */
NS_IMETHODIMP nsPluginOld::Shutdown()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void getMIMEDescription (out constCharPtr aMIMEDescription); */
NS_IMETHODIMP nsPluginOld::GetMIMEDescription(const char * *aMIMEDescription NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void getValue (in nsPluginVariable aVariable, in voidPtr aValue); */
NS_IMETHODIMP nsPluginOld::GetValue(nsPluginVariable aVariable, void * aValue)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
