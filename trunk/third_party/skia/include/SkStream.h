...
public:
	...
	*/
	...
	virtual void flush();
	virtual size_t getOffset() = 0; // compiled script experiment
...
public:
	...
	*/
	...
	virtual void flush();
	virtual size_t getOffset() { SkASSERT(0); return 0; } // compiled script experiment
private:
	SkFILE* fFILE;
};
...
public:
	...
	virtual bool write(const void* buffer, size_t size);
	virtual size_t getOffset() { return fBytesWritten; } // compiled script experiment
