...
public:
   ...
   virtual char *duplicateStringValue( const char *value, 
        unsigned int length = static_cast<unsigned int>(unknown) )
   {
      //@todo invesgate this old optimization
      //if ( !value  ||  value[0] == 0 )
      //   return 0;

      if ( length == static_cast<unsigned int>(unknown) )
...
static struct DummyValueAllocatorInitializer {
   ...
   {
      // ensure valueAllocator() statics are initialized before main()
      valueAllocator();
   }
} dummyValueAllocatorInitializer;
...
: cstr_( other.index_ != noDuplication &&  other.cstr_ != 0
                ...
                : other.cstr_ )
   , index_( other.cstr_ ? (other.index_ == noDuplication ? noDuplication
                                                          : duplicate)
                         : other.index_ )
{
}
...
{
   value_.string_ =
        valueAllocator()->duplicateStringValue( value.c_str(), 
...
Value::asInt() const
{
   ...
   case intValue:
      return value_.int_;
   case uintValue:
      JSON_ASSERT( value_.uint_ < static_cast<UInt>(maxInt)
                   &&  "integer out of signed integer range" );
      return value_.uint_;
   case realValue:
      JSON_ASSERT( value_.real_ >= minInt
                   &&  value_.real_ <= maxInt
...
Value::asUInt() const
{
   ...
   case intValue:
      JSON_ASSERT( value_.int_ >= 0  
                   &&  "Negative integer can not be converted "
                       "to unsigned integer" );
      return value_.int_;
   case uintValue:
      return value_.uint_;
   case realValue:
      JSON_ASSERT( value_.real_ >= 0
...
Value::isConvertibleTo( ValueType other ) const
{
   ...
   case uintValue:
      return ( other == nullValue  &&  value_.uint_ == 0 )
             || (other == intValue && value_.uint_ <= static_cast<UInt>(maxInt))
             || other == uintValue
             || other == realValue
             || other == stringValue
             || other == booleanValue;
   ...
   for ( Args::const_iterator it = args_.begin(); it != args_.end(); ++it )
   {
      ...
      if ( arg.kind_ == PathArgument::kindIndex )
      {
         if ( !node->isArray()  ||  node->isValidIndex( arg.index_ ) )
         {
            ...
            //(array value expected at position...)
         }
      ...
      else if ( arg.kind_ == PathArgument::kindKey )
      {
         ...
         {
            // Error: unable to resolve path
            // (object value expected at position...)
         }
         node = &((*node)[arg.key_]);
         if ( node == &Value::null )
         {
            // Error: unable to resolve path
            // (object has no member named '' at position...)
         }
      }
   }
   return *node;
